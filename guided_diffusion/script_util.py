...
def diffusion_defaults():
    ...
    return dict(
        ...
        loss_type="mse",  # "mse" | "bce_dice" — bce_dice combats class imbalance
        # Region-loss hyperparameters (only used when loss_type="bce_dice").
        # pos_weight ~ 1/positive_fraction; 200 counteracts ~0.5% lesion ratio.
...
def create_gaussian_diffusion(
    *,
    ...
    # Explicit string -> enum mapping takes precedence over the legacy
    # use_kl / rescale_learned_sigmas flags.
    if loss_type == "bce_dice":
        loss_type_enum = gd.LossType.BCE_DICE
    elif use_kl:
